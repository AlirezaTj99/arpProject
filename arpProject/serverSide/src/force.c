    ...
    while(TRUE)
    {
        ...
        if (reachedAllTheGoals)
        {
            ...
            if(str6[0]=='T')
            {
                ...
                if (str6[2]=='2' && str6[3]==']'){sscanf(str6, formatT2, &gx1, &gy1, &gx2, &gy2);}
                else if (str6[2]=='3' && str6[3]==']'){sscanf(str6, formatT3, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3);}
                else if (str6[2]=='4' && str6[3]==']'){sscanf(str6, formatT4, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4);}
                else if (str6[2]=='5' && str6[3]==']'){sscanf(str6, formatT5, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5);}
                else if (str6[2]=='6' && str6[3]==']'){sscanf(str6, formatT6, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6);}
                else if (str6[2]=='7' && str6[3]==']'){sscanf(str6, formatT7, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7);}
                else if (str6[2]=='8' && str6[3]==']'){sscanf(str6, formatT8, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8);}
                else if (str6[2]=='9' && str6[3]==']'){sscanf(str6, formatT9, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8, &gx9, &gy9);}
                else if (str6[2]=='1' && str6[3]=='0'){sscanf(str6, formatT10, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8, &gx9, &gy9, &gx10, &gy10);}
                else if (str6[2]=='1' && str6[3]=='1'){sscanf(str6, formatT11, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8, &gx9, &gy9, &gx10, &gy10, &gx11, &gy11);}
                else if (str6[2]=='1' && str6[3]=='2'){sscanf(str6, formatT12, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8, &gx9, &gy9, &gx10, &gy10, &gx11, &gy11, &gx12, &gy12);}
                else if (str6[2]=='1' && str6[3]=='3'){sscanf(str6, formatT13, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8, &gx9, &gy9, &gx10, &gy10, &gx11, &gy11, &gx12, &gy12, &gx13, &gy13);}
                else if (str6[2]=='1' && str6[3]=='4'){sscanf(str6, formatT14, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8, &gx9, &gy9, &gx10, &gy10, &gx11, &gy11, &gx12, &gy12, &gx13, &gy13, &gx14, &gy14);}
                else if (str6[2]=='1' && str6[3]=='5'){sscanf(str6, formatT15, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8, &gx9, &gy9, &gx10, &gy10, &gx11, &gy11, &gx12, &gy12, &gx13, &gy13, &gx14, &gy14, &gx15, &gy15);}
                else if (str6[2]=='1' && str6[3]=='6'){sscanf(str6, formatT16, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8, &gx9, &gy9, &gx10, &gy10, &gx11, &gy11, &gx12, &gy12, &gx13, &gy13, &gx14, &gy14, &gx15, &gy15, &gx16, &gy16);}
                else if (str6[2]=='1' && str6[3]=='7'){sscanf(str6, formatT17, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8, &gx9, &gy9, &gx10, &gy10, &gx11, &gy11, &gx12, &gy12, &gx13, &gy13, &gx14, &gy14, &gx15, &gy15, &gx16, &gy16, &gx17, &gy17);}
                else if (str6[2]=='1' && str6[3]=='8'){sscanf(str6, formatT18, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8, &gx9, &gy9, &gx10, &gy10, &gx11, &gy11, &gx12, &gy12, &gx13, &gy13, &gx14, &gy14, &gx15, &gy15, &gx16, &gy16, &gx17, &gy17, &gx18, &gy18);}
                else if (str6[2]=='1' && str6[3]=='9'){sscanf(str6, formatT19, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8, &gx9, &gy9, &gx10, &gy10, &gx11, &gy11, &gx12, &gy12, &gx13, &gy13, &gx14, &gy14, &gx15, &gy15, &gx16, &gy16, &gx17, &gy17, &gx18, &gy18, &gx19, &gy19);}
                else if (str6[2]=='2' && str6[3]=='0'){sscanf(str6, formatT20, &gx1, &gy1, &gx2, &gy2, &gx3, &gy3, &gx4, &gy4, &gx5, &gy5, &gx6, &gy6, &gx7, &gy7, &gx8, &gy8, &gx9, &gy9, &gx10, &gy10, &gx11, &gy11, &gx12, &gy12, &gx13, &gy13, &gx14, &gy14, &gx15, &gy15, &gx16, &gy16, &gx17, &gy17, &gx18, &gy18, &gx19, &gy19, &gx20, &gy20);}
            ...
            }else if(str6[0]=='O')
            {
                ...
                if (str6[2]=='2' && str6[3]==']'){sscanf(str6, formatO2, &ox1, &oy1, &ox2, &oy2);}
                else if (str6[2]=='3' && str6[3]==']'){sscanf(str6, formatO3, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3);}
                else if (str6[2]=='4' && str6[3]==']'){sscanf(str6, formatO4, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4);}
                else if (str6[2]=='5' && str6[3]==']'){sscanf(str6, formatO5, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5);}
                else if (str6[2]=='6' && str6[3]==']'){sscanf(str6, formatO6, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6);}
                else if (str6[2]=='7' && str6[3]==']'){sscanf(str6, formatO7, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7);}
                else if (str6[2]=='8' && str6[3]==']'){sscanf(str6, formatO8, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8);}
                else if (str6[2]=='9' && str6[3]==']'){sscanf(str6, formatO9, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8, &ox9, &oy9);}
                else if (str6[2]=='1' && str6[3]=='0'){sscanf(str6, formatO10, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8, &ox9, &oy9, &ox10, &oy10);}
                else if (str6[2]=='1' && str6[3]=='1'){sscanf(str6, formatO11, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8, &ox9, &oy9, &ox10, &oy10, &ox11, &oy11);}
                else if (str6[2]=='1' && str6[3]=='2'){sscanf(str6, formatO12, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8, &ox9, &oy9, &ox10, &oy10, &ox11, &oy11, &ox12, &oy12);}
                else if (str6[2]=='1' && str6[3]=='3'){sscanf(str6, formatO13, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8, &ox9, &oy9, &ox10, &oy10, &ox11, &oy11, &ox12, &oy12, &ox13, &oy13);}
                else if (str6[2]=='1' && str6[3]=='4'){sscanf(str6, formatO14, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8, &ox9, &oy9, &ox10, &oy10, &ox11, &oy11, &ox12, &oy12, &ox13, &oy13, &ox14, &oy14);}
                else if (str6[2]=='1' && str6[3]=='5'){sscanf(str6, formatO15, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8, &ox9, &oy9, &ox10, &oy10, &ox11, &oy11, &ox12, &oy12, &ox13, &oy13, &ox14, &oy14, &ox15, &oy15);}
                else if (str6[2]=='1' && str6[3]=='6'){sscanf(str6, formatO16, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8, &ox9, &oy9, &ox10, &oy10, &ox11, &oy11, &ox12, &oy12, &ox13, &oy13, &ox14, &oy14, &ox15, &oy15, &ox16, &oy16);}
                else if (str6[2]=='1' && str6[3]=='7'){sscanf(str6, formatO17, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8, &ox9, &oy9, &ox10, &oy10, &ox11, &oy11, &ox12, &oy12, &ox13, &oy13, &ox14, &oy14, &ox15, &oy15, &ox16, &oy16, &ox17, &oy17);}
                else if (str6[2]=='1' && str6[3]=='8'){sscanf(str6, formatO18, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8, &ox9, &oy9, &ox10, &oy10, &ox11, &oy11, &ox12, &oy12, &ox13, &oy13, &ox14, &oy14, &ox15, &oy15, &ox16, &oy16, &ox17, &oy17, &ox18, &oy18);}
                else if (str6[2]=='1' && str6[3]=='9'){sscanf(str6, formatO19, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8, &ox9, &oy9, &ox10, &oy10, &ox11, &oy11, &ox12, &oy12, &ox13, &oy13, &ox14, &oy14, &ox15, &oy15, &ox16, &oy16, &ox17, &oy17, &ox18, &oy18, &ox19, &oy19);}
                else if (str6[2]=='2' && str6[3]=='0'){sscanf(str6, formatO20, &ox1, &oy1, &ox2, &oy2, &ox3, &oy3, &ox4, &oy4, &ox5, &oy5, &ox6, &oy6, &ox7, &oy7, &ox8, &oy8, &ox9, &oy9, &ox10, &oy10, &ox11, &oy11, &ox12, &oy12, &ox13, &oy13, &ox14, &oy14, &ox15, &oy15, &ox16, &oy16, &ox17, &oy17, &ox18, &oy18, &ox19, &oy19, &ox20, &oy20);}
